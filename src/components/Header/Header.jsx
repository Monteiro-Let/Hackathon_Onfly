      ...
      <nav className="bg-off_white w-full p-4 flex flex-col lg:flex-row items-center lg:justify-between shadow-md">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-4 lg:gap-6">
          <div className="text-dark_medium_blue w-full lg:w-auto">
            ...
            >
              <option value="" className="disabled selected text-center">
                REDES HOTELEIRAS
              </option>
              <option value="https://all.accor.com">Accor</option>
              <option value="https://www.amerishoteis.com.br">Ameris</option>
              <option value="https://www.letsatlantica.com.br">
                Atlântica
              </option>
              <option value="https://www.choicehotels.com/pt-br">Choice</option>
              <option value="https://www.nacionalinn.com.br">
                Nacional Inn
              </option>
              <option value="https://www.wyndhamhotels.com/pt-br">
                Wyndham
              </option>
              <option value="https://windsorhoteis.com">Windsor</option>
              <option value="https://www.nobilehoteis.com.br">
                Nobile Hotels & Resorts
              </option>
              <option value="https://www.slavierohoteis.com.br">
                Hotéis Slaviero
              </option>
              <option value="https://bristolhoteis.com.br">
                Bristol Hotelaria
              </option>
              <option value="https://www.andradehoteis.com.br">
                Rede Andrade
              </option>
          ...
          <div className="w-full lg:w-auto text-center">
            <button
              onClick={() => (window.location.href = `${window.location.origin}/form`)}
